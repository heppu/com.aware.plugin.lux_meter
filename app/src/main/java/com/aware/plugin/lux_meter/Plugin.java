...
public class Plugin extends Aware_Plugin {
    ...
    private static boolean temp_mode = false;

    private LuxAlarm alarm = new LuxAlarm();
    ...
    public void onCreate() {
        ...
        if( Aware.getSetting(getApplicationContext(), Settings.SAMPLES_PLUGIN_LUX_METER).length() == 0 ) {
            Aware.setSetting(getApplicationContext(), Settings.SAMPLES_PLUGIN_LUX_METER, 30);
        }
